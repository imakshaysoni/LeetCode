...
public:
    ...
    void addLeafNodes(Node * root, vector<int> &result){
        Node * curr = root;
        if(curr and isLeafNode(curr)){
            result.push_back(curr->data);
            return;
        }
        if(curr->left) addLeafNodes(curr->left, result);
        if(curr->right) addLeafNodes(curr->right, result);
        
    }
    
    void addRightBoundaryNodes(Node * root, vector<int> &result){
    ...
    void boundaryTraversal(Node* root, vector<int> &result){
        ...
        addLeftBoundaryNodes(root, result);
        addLeafNodes(root, result);
        addRightBoundaryNodes(root, result);
